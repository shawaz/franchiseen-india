    ...
    <View style={styles.container}>
        ...
        <View style={styles.content}>
          <View style={{
            ...
            />
              ...
              <ThemedText style={styles.brandCategory}>
                {category}
              </ThemedText>
          </View>
          ...
          <View style={styles.tabContainer}>
            ...
            >
              <ThemedText style={[styles.tabText, activeTab === 'outlets' && styles.activeTabText]}>Outlets</ThemedText>
            </TouchableOpacity>
            <TouchableOpacity 
              style={[styles.tab, activeTab === 'products' && styles.activeTab]}
              onPress={() => setActiveTab('products')}
            >
              <ThemedText style={[styles.tabText, activeTab === 'products' && styles.activeTabText]}>Products</ThemedText>
            </TouchableOpacity>
            <TouchableOpacity 
              style={[styles.tab, activeTab === 'properties' && styles.activeTab]}
              onPress={() => setActiveTab('properties')}
            >
              <ThemedText style={[styles.tabText, activeTab === 'properties' && styles.activeTabText]}>Properties</ThemedText>
            </TouchableOpacity>
          </View>
              ...
              <View style={styles.outletsList}>
                {filteredProducts.length > 0 ? (
                  filteredProducts.map((products) => (
                    <View key={products.id} style={styles.outletCard}>
                      <Image 
                      ...
                      <View style={styles.outletInfo}>
                        <ThemedText style={styles.outletName}>{products.name}</ThemedText>
                          <ThemedText style={styles.outletAddress}>{products.address}</ThemedText>
                          <ThemedText style={styles.outletAddress}>{products.state} • {products.country}</ThemedText>
              ...
              <View style={styles.outletsList}>
                {filteredProperties.length > 0 ? (
                  filteredProperties.map((properties) => (
                    <View key={properties.id} style={styles.outletCard}>
                      <Image 
                      ...
                      <View style={styles.outletInfo}>
                        <ThemedText style={styles.outletName}>{properties.name}</ThemedText>
                          <ThemedText style={styles.outletAddress}>{properties.address}</ThemedText>
                          <ThemedText style={styles.outletAddress}>{properties.state} • {properties.country}</ThemedText>
                  ...
                  <View style={styles.noResultsContainer}>
                    <ThemedText style={styles.noResultsText}>No properties found</ThemedText>
                  </View>
                )}
              </View>
      ...
      <View style={styles.bottomContainer}>
        <TouchableOpacity 
          style={styles.button} 
          // onPress={() => router.push({
          //   pathname: '/(home)/brand/select-location',
          //   params: {
          //     brandId: id,
          //     brandName: title,
          //     category: category,
          ...
          // })}
        >
          <Text style={styles.buttonText}>BUY FRANCHISE</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
