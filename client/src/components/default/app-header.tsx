...
const AuthComponent = () => {
  ...
  if (isAuthenticated && (userProfile || privyUser)) {
    return (
      <div className="flex items-center gap-2">
        <span className="text-sm text-muted-foreground">
          {userProfile?.fullName || privyUser?.fullName || userProfile?.email || privyUser?.primaryEmailAddress?.emailAddress}
        </span>
